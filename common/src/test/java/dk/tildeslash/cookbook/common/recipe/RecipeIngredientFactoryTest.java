...
public class RecipeIngredientFactoryTest {
    ...
    @Test
    public void onlyIngredient() throws NotConfiguredException, DataStoreException, ConnectionException {
    ...
    @Test
    public void ingredientAndSuffix() throws NotConfiguredException, DataStoreException, ConnectionException {
    ...
    @Test
    public void ingredientAndPrefix() throws NotConfiguredException, DataStoreException, ConnectionException {
    ...
    @Test
    public void ingredientAndAmountWithComma() throws NotConfiguredException, DataStoreException, ConnectionException {
    ...
    @Test
    public void ingredientAndAmountWithPeriod() throws NotConfiguredException, DataStoreException, ConnectionException {
        RecipeIngredient reference = new RecipeIngredient("1.5", new Ingredient("salt", "salt", false), "");
        RecipeIngredient test = RecipeIngredientFactory.makeRecipeIngredient("1.5 salt");
        assertEquals("Reference and test should equal each other", reference, test);
    }
    ...
    @Test
    public void ingredientAndUnitAndAmount() throws NotConfiguredException, DataStoreException, ConnectionException {
    ...
    @Test
    public void ingredientGreedyName() throws NotConfiguredException, DataStoreException, ConnectionException {
    ...
    @Test
    public void ingredientAndAllParameters() throws NotConfiguredException, DataStoreException, ConnectionException {
    ...
    @Test
    public void pluralIngredient() throws NotConfiguredException, DataStoreException, ConnectionException {
    ...
    @Test
    public void noExsistingIngredient() throws NotConfiguredException, DataStoreException, ConnectionException {
    ...
    @Test
    public void emptyInputGivesNull() throws NotConfiguredException, DataStoreException, ConnectionException {
        RecipeIngredient test = RecipeIngredientFactory.makeRecipeIngredient("");
        assertNull("If input is \"\", it should return null.", test);
    }

    @Test
    public void nullInputGivesNull() throws NotConfiguredException, DataStoreException, ConnectionException {
        RecipeIngredient test = RecipeIngredientFactory.makeRecipeIngredient(null);
          assertNull("If input is \"\", it should return null.", test);
    }

    @Test
    public void amountAndPrefix() throws NotConfiguredException, DataStoreException, ConnectionException {
    ...
    @Test
    public void matchingPluralBeforeSingularAndSuffix() throws NotConfiguredException, DataStoreException, ConnectionException {
    ...
    @Test
    public void matchingWholeWordBeforePrefix() throws NotConfiguredException, DataStoreException, ConnectionException {
    ...
    @Test
    public void unknownIngredientWithIngredientAsSuffix() throws NotConfiguredException, DataStoreException, ConnectionException {
    ...
    @Test
    public void unknownIngredientWithIngredientAsPrefix() throws NotConfiguredException, DataStoreException, ConnectionException {
    ...
    @Test
    public void matchingUnitInWord() throws NotConfiguredException, DataStoreException, ConnectionException {
